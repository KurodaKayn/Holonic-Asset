...
import { quickGenerationSizes } from "./types";
...
import type { QuickGenerationController } from "./state/use-quick-generation";

export function QuickGenerationWorkspace({
  generation,
}: {
  generation: QuickGenerationController;
}) {
  const { model, actions } = generation;
